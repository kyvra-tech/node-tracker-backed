module github.com/kyvra-tech/pactus-nodes-tracker-backend
...
require (
	...
	github.com/pactus-project/pactus v1.10.0-rc2
...
require (
	...
	github.com/pacviewer/jrpc-gateway v0.6.0 // indirect
